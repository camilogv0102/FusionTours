...
wp_enqueue_script( 'jquery' );
	wp_enqueue_style(
		'fusion-front-home',
		get_template_directory_uri() . '/assets/css/front-home.css',
		array( 'blankslate-style' ),
		'1.0.0'
	);
	wp_enqueue_script(
		'fusion-front-home',
		get_template_directory_uri() . '/assets/js/front-home.js',
		array(),
		'1.0.0',
		true
	);
	if ( is_product() ) {
		wp_enqueue_style(
			'fusion-front-product',
			get_template_directory_uri() . '/assets/css/front-product.css',
			array( 'blankslate-style' ),
			'1.0.0'
		);
		wp_enqueue_script(
			'fusion-front-product',
			get_template_directory_uri() . '/assets/js/front-product.js',
...
if ( ! function_exists( 'blankslate_estimated_reading_time' ) ) {
	/**
	 * Generates a human readable estimated reading time string.
	 *
	 * @param string $content Post content.
	 * @return string
	 */
	function blankslate_estimated_reading_time( $content ) {
	...
	return sprintf( _n( '%s min de lectura', '%s mins de lectura', $minutes, 'blankslate' ), $minutes );
}
}
